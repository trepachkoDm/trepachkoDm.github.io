...
document.addEventListener("touchstart", self.BallTouchStart, false);
document.addEventListener("touchmove", self.BallTouchMove, false);
document.addEventListener("touchend", self.BallTouchEnd, false);
